...
namespace Rackspace.CloudFiles.Specs
{
    ...
    public class SpecAccountWhenUsingContainerName
    {
        ...
        private void AssertAllDoNotThrowError(string containername)
        {
            _account.CreateContainer(containername);
            _account.DeleteContainer(containername);
            _account.GetContainer(containername);
        }
        ...
        public void Setup()
        {
            var fakehttp = FakeHttpResponse.CreateWithResponseCode(HttpStatusCode.OK);
        ...
        public void it_has_to_have_a_name_no_longer_than_256_bytes()
        {
            ...
            AssertAllDoNotThrowError(shortname);
    ...
    public class SpecAccountWhenDeletingAContainerThatDoesNotExist
    {
        ...
        {
            Asserts.Throws<ContainerNotFoundException>(() => _account.DeleteContainer("foobar"));
        }
    }
    [TestFixture]
    ...
    [TestFixture]
    public class SpecAccountWhenGettingAContainerList:BaseSpec
    {
